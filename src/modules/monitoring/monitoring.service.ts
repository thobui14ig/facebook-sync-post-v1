  ...
  async processLinkPublicV1(link: LinkEntity) {
    ...
    if (link.postIdV1) {
      while (true) {
        ...
        try {
          if (link.postIdV1 === '122198444798045627') console.time('4')

          await this.facebookService.getCmtPublic(link.postIdV1, link)
          if (link.postIdV1 === '122198444798045627') console.timeEnd('4')
